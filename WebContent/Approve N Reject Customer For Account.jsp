	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<tr>
				<td>Phone No:</td><td><input type="text"t name="phone"  value="<%=lg.getPhone()%>"></td>
				</tr>
				<tr>
				...
				<tr>
				<td>User Name:</td><td><input type="text" name="uname" value="<%=lg.getUname()%>"></td>
				</tr>
				<tr>
				<td>Password:</td><td><input type="text" name="password" value="<%=lg.getPassword()%>"></td>
				</tr>
				<tr>
				<td>Current Status:</td><td><input type="text" name="status" value="<%=lg.getStatus()%>"></td>
				</tr>
