...
<jsp:directive.page import="bank.form.LoginForm"/>
	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<td>Your Account No is:</td><td><input type="text" name="t1" value="<%=request.getAttribute("key").toString() %>"></td>
				</tr>
				
				</table>
				<p><strong>CONGRATULATIONS!!!!!!YOUR ACCOUNT CREATED SUCCESSFULLY.</p>
				</form>
				</div>
			</div>
