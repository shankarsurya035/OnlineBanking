		...
		<div id="content">
			...
			<div class="post">
				...
				ArrayList<String>name=(ArrayList<String>)request.getAttribute("CATEGORY");
				 %>
				 <tr><td>Choose Loan To Edit</td></tr><td><select name="loan">
				 <%
				...
				<%} %></select>
				<tr>
				<td colspan="2" align="right"><input type=submit name="editLoan" value="editLoan"/></td></tr>
