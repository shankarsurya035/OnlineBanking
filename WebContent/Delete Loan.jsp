	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				ArrayList<String>name=(ArrayList<String>)request.getAttribute("CATEGORY");
				 %>
				 <tr><td>Choose Category</td></tr><td><select name="loan">
				 <%
				...
				<%} %></select>
				<tr>
				<td colspan="2" align="right"><input type="submit" name="deleteLoan" value="deleteLoan"/><br /></td></tr>
