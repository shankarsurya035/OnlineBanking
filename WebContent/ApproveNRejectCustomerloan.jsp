	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<form action="login" >
				<%
				ArrayList<String>id=(ArrayList<String>)request.getAttribute("ACCOUNTNO");
				//ArrayList<String>name=(ArrayList<String>)request.getAttribute("NAME");
				 %>
				 <tr><td>Choose Customer here</td></tr><td><select name="customer">
				 <%
				...
				<%} %></select>
				<tr>
				<td colspan="2" align="right"><input type="submit" name="ApproveORRejectloan" value="ApproveORRejectloan"/></td></tr>
		...
		<div id="sidebar">
			<ul>
				<li><h2><a href="#">ApproveNRejectCustomer</h2>
