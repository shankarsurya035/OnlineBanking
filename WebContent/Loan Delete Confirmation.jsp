	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<tr>
				<td>Category:</td><td><input type="text" name="category" value="<%=lg.getCategory() %>"></td>
				</tr>
				<tr>
				<td>Rate Of Intrest:</td><td><input type="text" name="rate" value="<%=lg.getRate() %>"></td>
				</tr>
				<tr>
				<td>Maximum Time Limit(In Years):</td><td><input type="text" name="date" value="<%=lg.getDate() %>"></td>
				</tr>
				<tr>
				<td>Maximum Loan Amount(In Lakh):</td><td><input type="text" name="amount" value="<%=lg.getAmount() %>"></td>
				</tr>
				
				<td><input type="submit" name="ConfirmedDelete" value="ConfirmedDelete"></td>
				</table>
				</form>
				</div>
			</div>
		...
		<div id="sidebar">
			<ul>
				<li><h2><a href="#">Loan Delete Confirmation</h2>
