...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				ArrayList<String>name=(ArrayList<String>)request.getAttribute("ENAME");
				 %>
				 <tr><td>Choose Employee name here</td></tr><td><select name="ename">
				 <%
				...
				<%} %></select>
				<tr>
				<td colspan="2" align="right"><input type="submit" name="deleteEmployee" value="deleteEmployee"/><br /></td></tr>
		...
		<div id="sidebar">
			<ul>
				<li><h2><a href="#">Delete Employee</h2>
