	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<tr>
				<td>Reason To Delete the Account:</td><td><input type="text" name="reason"></td>
				</tr>
				
				
				<td><input type="submit" name="ApplyToDelete" value="ApplyToDelete"></td>
