...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				ArrayList<String> id=(ArrayList<String>)request.getAttribute("ACCOUNTNO");
				 ...
				 %>
				 <tr><td>Choose Account no To Delete</td></tr><td><select name="account">
				 <%
				...
				<%} %></select>
				<tr>
				<td colspan="2" align="right"><input type="submit" name="Verify" value="Verify"/><br /></td></tr>
		...
		<div id="sidebar">
			<ul>
				<li><h2><a href="#">Delete Account(For Admin)</h2>
