...
<body>
   ...
   Object ob=s.getAttribute("uname");
   String SL_NO=s.getAttribute("SL_NO").toString();
   System.out.println(SL_NO);
  
   String uname=ob.toString();
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="sidebar">
			<ul>
				<li>
					<h2><a href="#">User Home</h2>
				
				</li>
				<li>
					<h2>Links</h2>
					<ul>
						<li><span></span><a href="Delete Account.jsp">Delete Account</a></li>
						<li><span></span><a href="Cash Deposite.jsp">Cash Deposite</a></li>
						<li><span></span><a href="Cash Withdrawal.jsp">Cash Withdrawal</a></li>
						<li><span></span><a href="View Balance.jsp">View Balance</a></li>
						<li><span></span><a href="Money Transefer.jsp">Money Transefer</a></li>
						<li><span></span><a href="login?RetrieveLoan=RetrieveLoan">Apply For Loan</a></li>
						<li><span></span><a href="View Notice.jsp">View Notice</a></li>
        <li><span></span><a href="login?Viewprofile=Viewprofile&key=<%=SL_NO%>&key1=<%=uname%>">View Profile</a></li>
        <li><span></span><a href="login?Editprofile=Editprofile&key=<%=SL_NO%>&key1=<%=uname%>">Edit Profile</a></li>
					</ul>
				</li>
			</ul>
		</div>
