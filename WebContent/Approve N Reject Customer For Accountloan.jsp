	...
	<div id="page">
		<div id="content">
			...
			<div class="post">
				...
				<tr>
				<td>Catagory:</td><td><input type="text" name="name" value="<%=lg.getName()%>"></td>
				</tr>
				<tr>
				<td>Loan ID:</td><td><input type="text" name="address" value="<%=lg.getLoan()%>"  ></td>
				</tr>
				<tr>
				<td>INTEREST</td><td><input type="text"t name="interest"  value="<%=lg.getPhone()%>"></td>
				</tr>
				<tr>
				<td>GUARENTORACCOUNTNO</td><td><input type="text" name="gender" value="<%=lg.getDaccno()%>"></td>
				</tr>
				<tr>
				<td>REASONFORLOAN:</td><td><input type="text" name="email" value="<%=lg.getOccupation()%>"></td>
				</tr>
				<tr>
				<td>MODGADGEITEM:</td><td><input type="text" name="occupation" value="<%=lg.getAddress()%>"></td>
				</tr>
				
				<tr>
				<td>issueddate:</td><td><input type="text" name="issueddate" value="<%=lg.getIssuedate()%>"></td>
				</tr>
				<tr>
				<td>STATUS:</td><td><input type="text" name="password" value="<%=lg.getStatus()%>"></td>
				</tr>
				<tr>
				<td>ANNUALINCOME:</td><td><input type="text" name="status" value="<%=lg.getAmount()%>"></td>
				</tr>
				<td><input type="submit" name="Approvel" value="Approvel"></td>
				<td><input type="submit" name="Rejectl" value="Rejectl"></td>
				</table>
				</form>
				</div>
			</div>
		...
		<div id="sidebar">
			<ul>
				<li><h2><a href="#">Approve N Reject Customer For Account</h2></li>		
				...
				<li>
					<h2>Links</h2>
					<ul>
						<li><span></span><a href="Admin Home.jsp">Home</a></li>
